...
# Test all dog images from dog.4001.jpg to dog.5000.jpg and count predictions
if __name__ == "__main__":
    # Path to the folder containing the dog images to be tested
    test_image_folder = 'dataset/test_set/dogs/'
    cat_count = 0
    dog_count = 0

    # Loop through the image filenames from dog.4001.jpg to dog.5000.jpg
    for i in range(4001, 5001):
        image_filename = f'dog.{i}.jpg'
